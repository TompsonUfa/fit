    ...
    init: function (editor) {
        editor.widgets.add("html5video", {
            ...
            upcast: function (element) {
                return (
                    element.name === "div" &&
                    element.hasClass("ckeditor-html5-video")
                );
            },
            dialog: "html5video",
            init: function () {
            ...
            data: function () {
                ...
                if (this.data.src) {
                    ...
                    if (this.data.poster)
                        this.element
                            .getChild(0)
                            .setAttribute("poster", this.data.poster);
                }
                ...
                if (this.element.getChild(0)) {
                    ...
                    if (this.data.advisorytitle) {
                        this.element
                            .getChild(0)
                            .setAttribute("title", this.data.advisorytitle);
                    } else {
