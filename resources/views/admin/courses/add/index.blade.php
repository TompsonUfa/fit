...
@endsection
@push('scripts')
    @vite(['resources/sass/app.scss', 'resources/sass/style.scss', 'resources/js/bootstrap.js', 'resources/js/sidebar.js', 'resources/js/editor.js', 'resources/js/change-img.js', 'resources/js/sending-posts.js'])
@endpush
