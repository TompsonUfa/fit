...
@section('title', 'Панель администратора | 5 причин обучаться')
...
@section('content')
    <div class="row-12">
        <div class="panel p-3 p-md-5 mt-5">
            ...
            <a href="reasons/add" class="btn btn-success panel__btn mb-3">Добавить информацию
                                    ...
                                    <tr data-item-id={{ $item['id'] }}>
                                        <td class="align-middle text-center">
                                            <img class="table__img"
                                                src="/storage/media/reasons/{{ $item['id'] . '/' . $item['img'] . '.webp?=r' . rand(0, 999999) }}"
                                                alt="{{ $item['title'] }}">
                                        </td>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="{{ url('admin/reasons/edit') }}{{ '/' . $item['id'] }}"
