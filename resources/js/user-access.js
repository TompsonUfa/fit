window.addEventListener("DOMContentLoaded", () => {
    ...
    if (modal != null) {
        let modalUser = modal.querySelector(".modal-extend__user")
        let modalDate = modal.querySelector(".modal-extend__date")
        let modalInput = modal.querySelector(".modal-extend__input")
        let modalBtn = modal.querySelector(".modal-extend__btn");
